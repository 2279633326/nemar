        ...
        <div class="account_grid">
            <div class="col-md-6 login-right">
                    ...
                    <form action="${path}/user/login" method="post">
                        <span>用户名:</span><input type="text" name="userName" style="border:1px #4c4c4c solid;width: 300px;height: 30px"/>
                        <span>密码：</span><input type="password" name="password" style="border:1px #4c4c4c solid;width: 300px;height: 30px"/>
                    </form>
                    <%--<span>Password</span>--%>
                    <%--<input type="text">--%>
                        <div class="word-in">
                        ...
                        <span></span>
                        <input type="submit" value="登录" height="20px">
                    </div>
            </div>
            <div class="col-md-6 login-left">
                <h4>NEW CUSTOMERS</h4>
                <p>By creating an account with our store, you will be able to move through the checkout process faster, store multiple shipping addresses, view and track your orders in your account and more.</p>
                <a class="acount-btn" href="register.jsp">创建一个帐户</a>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
